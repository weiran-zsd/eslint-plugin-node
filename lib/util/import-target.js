...
module.exports = class ImportTarget {
     ...
     * Initialize this instance.
     * @param {import('eslint').Rule.RuleContext} context - The context for the import origin.
     * @param {import('estree').Node} node - The node of a `require()` or a module declaraiton.
    ...
    getModuleStyle(fallback) {
        ...
        do {
            ...
            if (
                ...
                /** @type {import('@typescript-eslint/typescript-estree').TSESTree.ImportDeclaration} */ (
                    node
                ).importKind === "type"
            ) {
                return "type"
