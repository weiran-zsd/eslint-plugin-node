...
/**
 * @typedef {import('@typescript-eslint/typescript-estree').TSESTree.ImportDeclaration} TSImportDeclaration
 */
    ...
    getModuleStyle(fallback) {
        ...
        do {
            ...
            if (
                ...
                /** @type TSImportDeclaration */ (node.parent).importKind ===
                    "type"
            ) {
                return "type"
            }
            ...
            if (
                ...
                /** @type TSImportDeclaration */ ((node.parent).importKind ==
                    null ||
                    /** @type TSImportDeclaration */ (node.parent)
                        .importKind === "value")
            ) {
                return "import"
            }
