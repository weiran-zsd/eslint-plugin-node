 ...
 * @returns {import('type-fest').PackageJson|null} The read `package.json` data, or null.
 */
 ...
 * @returns {import('type-fest').PackageJson|null} A found `package.json` data or `null`.
