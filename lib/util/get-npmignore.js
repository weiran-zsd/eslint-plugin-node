 ...
 *
 * @param {NonNullable<ReturnType<getPackageJson>>} p - An object of package.json.
 ...
 *
 * @param {string[] | undefined} files - File names of whitelist.
...
module.exports = function getNpmignore(startPath) {
    ...
    const filesIgnore = parseWhiteList(
        /** @type {string[] | undefined} */ (packageJson.files)
    )
